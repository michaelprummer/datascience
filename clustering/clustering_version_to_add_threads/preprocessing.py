...
class Preprocessing():
    ...
    def __init__(self):
        ...
        self.stopwords = ["when","and","why","here","now","never","sometimes","too","the","not","youre","are","have","be","been","always","never","forever","would","should","has"]
    ...
    def preprocess_tweet(self, tweet):
        ...
        for i in range(len(tweet)):
            ...
            if len(tweet[i]) < 3:
                tweet[i] = "" 
            elif tweet[i] in self.stopwords:
                tweet[i]= ""   
            elif tweet[i] in self.personal_pronomen:
                tweet[i] = ""
            elif tweet[i] in self.praepositionen:
                tweet[i] = ""
