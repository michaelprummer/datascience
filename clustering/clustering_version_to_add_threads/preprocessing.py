...
class Preprocessing():
    ...
    def __init__(self):
        ...
        # many terms are ignored since they are too less informative for trend/topic detection.
    ...
    def read_with_numpy(self, path, limit=None):
        """
        Load tweets with numpy and preprocess tweets.
        """
        counter = 0
        
        print("Loading tweets from " + path, end=" - ")
        t0 = time()
        tweets = numpy.loadtxt(path, dtype='str', delimiter="\t", usecols = [3],comments=None)
    ...
    def preprocess_tweet(self, tweet):
        ...
        # decode tweet since tokenizer needs unicode.
        tweet = tweet.decode(encoding="utf-8")
        
        # tokenization.
        tweet = self.tok.tokenize(tweet)

        # remove URLs, @User, process hashtags.
        for i in range(len(tweet)):
            ...
            # remove everything except of letters and whitspace    
        ...
        # return tweet in utf-8 encoding.
